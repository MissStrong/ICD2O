...
The **file tree** is the list of files and folders that make up a program. For now our programs will just be one file called **default.js**. The **js** file extension is for JavaScript files.
